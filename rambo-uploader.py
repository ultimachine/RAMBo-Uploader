...
class window(wx.Frame):
	...
	def OnLoad(self,event):
		...
		if dlg.ShowModal() == wx.ID_OK:
			...
			self.isp1.__dict__.update(eval(self.config.get('uploader', 'isp1')))
			self.isp2.__dict__.update(eval(self.config.get('uploader', 'isp2')))
			self.avr1.__dict__.update(eval(self.config.get('uploader', 'avr1')))
			self.avr2.__dict__.update(eval(self.config.get('uploader', 'avr2')))
