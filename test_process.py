...
stepperTestRPS = 5 #rotations per second for the stepper test
...
controllerPort = "/dev/serial/by-id/usb-UltiMachine__ultimachine.com__RAMBo_7403532343435170A021-if00"
